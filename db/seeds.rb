...
Unit.create({"icon" => "entities/transporter-big.png", "name"=>"Großer Transporter", "metal_price"=>20, "crystal_price"=>8, "fuel_price"=>0, "shell"=>8, "damage"=>0, "damage_type"=>damage, "cargo"=>400, "speed"=>8, "conditions"=>"f:1:8,f:4:8,g:6:8", "message"=>message3, "condition_id" => 3})
